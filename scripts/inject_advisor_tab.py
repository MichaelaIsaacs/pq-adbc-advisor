...
<section class="tab" id="tab-advisor">
  ...
  <div class="desc" style="margin-bottom:12px">
    How many workspaces have run the advisor at least once?
  </div>
  <div class="adv-kpi-row">
    ...
    <div class="adv-kpi"><div class="adv-kpi-val">{len(versions)}</div><div class="adv-kpi-lbl">Released versions</div></div>
  </div>
  ...
  <div class="desc" style="margin-bottom:12px">
    How the repo itself is being discovered. Traffic API is 14-day rolling;
    release downloads are cumulative.
  </div>
  <div class="adv-kpi-row">
    <div class="adv-kpi"><div class="adv-kpi-val">{int(gh.get("clones_14d", 0))}</div><div class="adv-kpi-lbl">Clones (14d) · {int(gh.get("unique_cloners_14d", 0))} unique</div></div>
    <div class="adv-kpi"><div class="adv-kpi-val">{int(gh.get("views_14d", 0))}</div><div class="adv-kpi-lbl">Views (14d) · {int(gh.get("unique_viewers_14d", 0))} unique</div></div>
    <div class="adv-kpi"><div class="adv-kpi-val">{int(gh.get("total_release_downloads", 0))}</div><div class="adv-kpi-lbl">Release downloads · {int(gh.get("release_count", 0))} tags</div></div>
  ...
  <div class="adv-2col">
    <div class="adv-card">
      <div class="adv-card-h">Releases <span class="adv-card-sub">(downloads per tag)</span></div>
      <div id="advReleasesTable"></div>
    </div>
    <div class="adv-card">
